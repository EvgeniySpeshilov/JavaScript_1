...
function  encryptor(password) {
	...
	const cell1 = encryptorPassword[2]; // Запоминаем символ или букву из пароля с адресом 4
	...
	encryptorPassword[2] = '$';         // Заменяет элемент на с адресом 4 на"$" 
    const cell2 = encryptorPassword[4]; // Запоминаем символ или букву из пароля с адресом 2
	...
	encryptorPassword[4] = '&';         // Заменяет элемент массива с адресом 2 на "&"
	...
	return console.log(`Зашифрованый пароль: ${encryptorPassword}`); // вывод зашифрованного пароля
		...
		}else {	console.log('Короткий пароль, нужно больше 7 символов');  // Выводит сообщение если пароль меньше 7 символов
	} 
} 
